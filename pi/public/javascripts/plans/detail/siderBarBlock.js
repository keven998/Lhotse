...
var InfoBlock = {
    ...
    getAjaxData  : function (url, params, callback) {
        var me = this;
        $.ajax({
            url    : url, //数据请求地址
            data   : params,
    ...
    render    : function (data) {//侧栏渲染入口函数
        ...
        me.getAjaxData(me.url, me.id, function (data) {  //发起请求
            me.html(data);  //ajax回调函数
        })
    },
    html         : function (data) {//getAjaxData 请求结果回调
        ...
        me.container.append('<div class="info ' + me.mode + '">' + htmlstr + '</div>');
        me.show();
    },
        ...
        switch ( modename ) {
            ...
            case 'hotel':
                testHtml = [
                    ...
                    '            <img class="qui-slide-img" src="images/s1.jpg" onerror="this.src=\'images/poi_80_80.png\'">',
                    '        </div>',
                    '        <ul class="qui-slide-ul">',
                    '            <li>',
                    '                <img src="images/ss1.jpg" data-src="images/s1.jpg" onerror="this.src=\'images/poi_80_80.png\'" class="qui-slide-li_active">',
                    '            </li>',
                    '            <li>',
                    '                <img src="images/ss2.jpg" data-src="images/s2.jpg" onerror="this.src=\'images/poi_80_80.png\'">',
                    '            </li>',
                    '            <li>',
                    '                <img src="images/ss3.jpg" data-src="images/s3.jpg" onerror="this.src=\'images/poi_80_80.png\'">',
                    '            </li>',
                    '        </ul>',
