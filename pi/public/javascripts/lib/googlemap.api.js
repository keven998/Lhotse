...
define(['async!http://ditu.google.cn/maps/api/js?v=3&sensor=false&libraries=geometry&key=AIzaSyCuXDkC1uoHaSctnrsGSGfpj9QVCUrfw1w'], function() {
    ...
    var GMaper = function(h) {
        ...
        that.distance = function(latLng_1, latLng_2) {
            var distance = google.maps.geometry.spherical.computeDistanceBetween(latLng_1, latLng_2);
            return distance;
        };
        that.drawRoute = function(f, dom, mode, callback) {
            ...
            directionsService.route({
                ...
                if (state == google.maps.DirectionsStatus.OK && (
                    ...
                    directionsRenderer.setPanel(dom),
        ...
        that.drawDriveRoute = function(h, dom, l) {
            that.drawRoute(h, dom, google.maps.TravelMode.DRIVING, l);
        };
        that.drawPublicTransitRoute = function(h, dom, l) {
            that.drawRoute(h, dom, google.maps.TravelMode.TRANSIT, l);
        };
